...
Begin VB.Form frmConsole_Relatorio_Triagem 
   AutoRedraw      =   -1  'True
   ...
   EndProperty
   Icon            =   "frmConsole_Relatorio_Triagem.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.CommandButton cmdConfiguracao_relatorio 
      Height          =   795
      Left            =   11670
      Picture         =   "frmConsole_Relatorio_Triagem.frx":1CCA
      Style           =   1  'Graphical
      TabIndex        =   1
   ...
   Begin VB.CommandButton cmdConfiguracao_impressora 
      Height          =   795
      Left            =   10710
      Picture         =   "frmConsole_Relatorio_Triagem.frx":3994
      Style           =   1  'Graphical
      TabIndex        =   0
   ...
   End
End
Attribute VB_Name = "frmConsole_Relatorio_Triagem"
...
' Sistema................: Retaguarda                                                     '
' Módulo.................: Serviços                                                       '
' Objetivo...............: Console Relatório Triagem                                      '
...
Private Sub Form_Load()
    ...
    intTamanho_string = Len(frmRelatorio_Triagem.strSql)
    inttamanho_From = InStr(1, frmRelatorio_Triagem.strSql, "FROM")
    strSql_antes_from = Mid(frmRelatorio_Triagem.strSql, 1, inttamanho_From - 1)
    strSql_pos_from = Mid(frmRelatorio_Triagem.strSql, inttamanho_From, intTamanho_string)
   ...
   conexao_relatorio.Abrir_conexao ("Otica")
    ...
    strCaminho = Funcoes_Gerais.Abrir_relatorio_registro("Otica", Me) & "\rptRelatorio_Triagem.rpt"
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    frmRelatorio_Triagem.optAtivos_Todos.Value = True
    frmRelatorio_Triagem.optBloqueados_Todos.Value = True
