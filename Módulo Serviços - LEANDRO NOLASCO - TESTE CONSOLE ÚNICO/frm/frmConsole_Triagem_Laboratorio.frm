...
Begin VB.Form frmConsole_Triagem_Laboratorio 
   AutoRedraw      =   -1  'True
   ...
   EndProperty
   Icon            =   "frmConsole_Triagem_Laboratorio.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.CommandButton cmdConfiguracao_impressora 
      Height          =   795
      Left            =   10710
      Picture         =   "frmConsole_Triagem_Laboratorio.frx":1CCA
      Style           =   1  'Graphical
      TabIndex        =   1
   ...
   Begin VB.CommandButton cmdConfiguracao_relatorio 
      Height          =   795
      Left            =   11670
      Picture         =   "frmConsole_Triagem_Laboratorio.frx":3994
      Style           =   1  'Graphical
      TabIndex        =   0
   ...
   End
End
Attribute VB_Name = "frmConsole_Triagem_Laboratorio"
...
Private Sub Form_Load()
    ...
    intTamanho_string = Len(frmTriagem_Laboratorio.strSql)
    inttamanho_From = InStr(1, frmTriagem_Laboratorio.strSql, "FROM")
    strSql_antes_from = Mid(frmTriagem_Laboratorio.strSql, 1, inttamanho_From - 1)
    strSql_pos_from = Mid(frmTriagem_Laboratorio.strSql, inttamanho_From, intTamanho_string)
    ...
    strCaminho = Funcoes_Gerais.Abrir_relatorio_registro("Otica", Me) & "\rptTriagem_Laboratorio.rpt"
