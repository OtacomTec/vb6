...
Begin VB.Form frmConsole_Insumo 
   ...
   EndProperty
   Icon            =   "frmConsole_Insumo.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form2"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin VB.CommandButton cmdConfiguracao_relatorio 
      Height          =   795
      Left            =   11670
      Picture         =   "frmConsole_Insumo.frx":038A
      Style           =   1  'Graphical
      TabIndex        =   1
   ...
   Begin VB.CommandButton cmdConfiguracao_impressora 
      Height          =   795
      Left            =   10710
      Picture         =   "frmConsole_Insumo.frx":2054
      Style           =   1  'Graphical
      TabIndex        =   0
   ...
   End
End
Attribute VB_Name = "frmConsole_Insumo"
...
Private Sub Form_Load()
    ...
    intTamanho_string = Len(frmInsumo.strSql)
    inttamanho_From = InStr(1, frmInsumo.strSql, "FROM")
    strSql_antes_from = Mid(frmInsumo.strSql, 1, inttamanho_From - 1)
    strSql_pos_from = Mid(frmInsumo.strSql, inttamanho_From, intTamanho_string)
