...
Begin VB.Form frmTipo_Atendimento_Servico 
   AutoRedraw      =   -1  'True
   ...
   EndProperty
   Icon            =   "frmTipo_Atendimento_Servico.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   ScaleHeight     =   3015
   ScaleWidth      =   5220
   Begin TabDlg.SSTab sstTipo_Atendimento_Servico 
      Height          =   2685
      Left            =   0
      TabIndex        =   11
      Top             =   330
      ...
      Begin VB.CommandButton cmdRefresh 
         Height          =   360
         Left            =   -70290
         Picture         =   "frmTipo_Atendimento_Servico.frx":17BA
         Style           =   1  'Graphical
         TabIndex        =   3
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton cmdConsulta 
         Height          =   360
         Left            =   -70680
         Picture         =   "frmTipo_Atendimento_Servico.frx":27FC
         Style           =   1  'Graphical
         TabIndex        =   2
      ...
      Begin VB.TextBox txtDescricao 
         ...
         Width           =   4935
      End
      Begin MSHierarchicalFlexGridLib.MSHFlexGrid hfgTipo_Atendimento_Servico 
         Height          =   1365
         Left            =   -74880
         TabIndex        =   5
         Top             =   1200
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTipo_Atendimento_Servico.frx":44F6
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTipo_Atendimento_Servico.frx":4810
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTipo_Atendimento_Servico.frx":4B2A
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTipo_Atendimento_Servico.frx":4EC4
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTipo_Atendimento_Servico.frx":525E
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTipo_Atendimento_Servico.frx":5578
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTipo_Atendimento_Servico.frx":5892
            Key             =   ""
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "frmTipo_Atendimento_Servico"
...
' Sistema................: Only Tech                                                      '
' Módulo.................: Serviços                                                       '
' Objetivo...............: Cadastro Tipo Atendimento Serviço                              '
' Equipe Responsável.....: Only Tech Solutions                                            '
' Desenvolvedor..........: Leandro Nolasco                                                '
...
Function Imprimir()
    ...
    Set frmAux_Imp = New frmConsole
    
    strFormulas = "Cliente;Tipo_relatorio"
    strValores = Funcoes_Gerais.Abrir_nome_cliente_registro("Otica", Me) & ";Listagem Geral"
    
    frmAux_Imp.setParametros strSQL, "rptTipo_Atendimento_Servico.rpt", strFormulas, strValores
    frmAux_Imp.Show
...
Private Sub Form_Load()
    ...
    log.Programa = "Cadastro de Tipo de Atendimento Serviço"
    ...
    If MDIPrincipal.booDesign_time = False Then
       Call Movimentacoes.Acessibilidade_inicio(Me.Caption, cmdConsulta, cmdRefresh, Me.sstTipo_Atendimento_Servico, booPrivilegio_Incluir, booPrivilegio_Alterar, booPrivilegio_Excluir, booPrivilegio_Consultar, MDIPrincipal.OCXUsuario.Codigo, tlbBotoes, Me, "Otica", "BDRetaguarda")
    Else
    ...
    log.Descricao = "Inicializando o cadastro de Tipo de Atendimento Serviço"

    'Gravando o log
    log.Gravar_log "Otica", Me

    sstTipo_Atendimento_Servico.Tab = 1
    sstTipo_Atendimento_Servico.TabEnabled(0) = False
    Call Reposicao
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    log.Evento = "Unload"
    log.Hora = Format(Now, "hh:mm:ss")
    log.Descricao = "Finalizando o cadastro de Tipo de Atendimento Serviço"
    'Gravando Log
    log.Gravar_log "OTICA", Me
...
Private Sub hfgTipo_Atendimento_Servico_click()

   If hfgTipo_Atendimento_Servico.Col = 0 And hfgTipo_Atendimento_Servico.Text <> Empty Then
      ...
      txtCodigo.Text = hfgTipo_Atendimento_Servico.TextArray((hfgTipo_Atendimento_Servico.Row * hfgTipo_Atendimento_Servico.Cols + hfgTipo_Atendimento_Servico.Col + 1))
      txtDescricao.Text = hfgTipo_Atendimento_Servico.TextArray((hfgTipo_Atendimento_Servico.Row * hfgTipo_Atendimento_Servico.Cols + hfgTipo_Atendimento_Servico.Col + 2))

      booAlterar = True
      txtConsulta.Text = Empty
      sstTipo_Atendimento_Servico.TabEnabled(0) = True
      sstTipo_Atendimento_Servico.Tab = 0
...
Private Sub hfgTipo_Atendimento_Servico_DblClick()
    hfgTipo_Atendimento_Servico.Sort = 1
End Sub

Private Sub hfgTipo_Atendimento_Servico_KeyPress(KeyAscii As Integer)
    If KeyAscii = 32 Then
       Call hfgTipo_Atendimento_Servico_click
    End If
End Sub

Private Sub sstTipo_Atendimento_Servico_Click(PreviousTab As Integer)
    If sstTipo_Atendimento_Servico.Tab = 0 Then
       txtDescricao.SetFocus
    ElseIf sstTipo_Atendimento_Servico.Tab = 1 Then
       If frmIntegracao.Visible = True Then
          Unload frmIntegracao
       End If
       ...
       ElseIf strCombo = "Todos" Then
          hfgTipo_Atendimento_Servico.Row = 1
          hfgTipo_Atendimento_Servico.Col = 0
          hfgTipo_Atendimento_Servico.SetFocus
      End If
   End If
End Sub
...
Private Sub tlbBotoes_ButtonClick(ByVal Button As MSComctlLib.Button)
    Select Case Button.Index
           Case 1: Call Novo
           Case 2 And sstTipo_Atendimento_Servico.Tab <> 1: Call Gravar
...
Function Gravar()
    ...
    If txtCodigo.Text <> Empty And booAlterar = False Then
        Movimentacoes.Verifica_Numero "PKCodigo_TBAtendimento", "TBTipo_Atendimento_Servico", txtCodigo, "Otica", Me
    End If

    Call Objetos.Maiusculo_TXT(Me)

    strCampo = "PKCodigo_TBAtendimento, DFDescricao_Tipo_atendimento"

    If booIntegra_Portal = True Then
        strCampo = strCampo & ",DFIntegrado_portal_TBTipo_atendimento_servico"
    End If
    ...
    If booAlterar = True Then
       ...
       strSet = "SET DFDescricao_Tipo_atendimento = '" & Funcoes_Gerais.Grava_String(txtDescricao.Text) & "'," & _
                "DFIntegrado_filiais_TBTipo_atendimento_servico = 0"

        If booIntegra_Portal = True Then
            strSet = strSet & ",DFIntegrado_portal_TBTipo_atendimento_servico = 0"
        End If

       Call funcoes_banco.Alterar("TBTipo_atendimento_servico", strSet, "PKCodigo_TBAtendimento", txtCodigo.Text, "Otica", Me, "BDRetaguarda")

       log.Descricao = "Alterando o registro: " + txtCodigo.Text
       log.Tipo = 1
       log.Hora = Format(Now, "hh:mm:ss") 'achava mais interessante sempre pegar data e hora do servidor de banco de dados, utilizando getdate(). Era interessante pegar data e hora...
       'Gravando log
       log.Gravar_log "OTICA", Me
    Else
       log.Evento = "Incluir Novo"

       Call funcoes_banco.Gravar("TBTipo_atendimento_servico", strCampo, strValores, "Otica", Me, "BDRetaguarda")
    ...
    If booPrivilegio_Consultar = False Then
       Me.hfgTipo_Atendimento_Servico.Visible = False
    End If
...
Private Function Excluir()
    ...
    strSQL = "SELECT PKid_atendimento, FKCodigo_TStatus_Pendencia_Servico FROM TBatendimento " & _
             "WHERE FK_TBAtendimento_TBTipo_atendimento_servico = " & txtCodigo.Text

    Select_geral strSQL, "BDRetaguarda", rstAplicacao, "Otica", Me
    If rstAplicacao.RecordCount <> 0 Then
       MsgBox "Este Tipo de Atendimento Serviço está vinculado a tabela Atendimento no registro " & rstAplicacao.Fields("PKId_Atendimento") & " e não poderá ser excluída. Verifique.", vbInformation, "Only Tech"
    ...
    'Excluindo Registro
    Call funcoes_banco.Excluir("TBTipo_atendimento_servico", "PKCodigo_TBAtendimento", txtCodigo.Text, "Otica", Me, "BDRetaguarda")
    ...
    If booPrivilegio_Consultar = False Then
       hfgTipo_Atendimento_Servico.Visible = False
    End If
...
Private Function Reposicao()
    ...
    Movimentacoes.Monta_HFlex_Grid hfgTipo_Atendimento_Servico, "1000,3500", "Código,Descrição", 2, "Otica", Me
...
Private Function Consulta()
    ...
    strSQL = "SELECT TAS.PKCodigo_TBAtendimento AS Codigo, TAS.DFDescricao_Tipo_atendimento AS Descricao " & _
             "FROM TBTipo_Atendimento_Servico TAS "
    ...
    If cbbCampos.Text <> "Todos" Then
       If cbbCampos.Text = "Código" Then
          strSQL = strSQL & " WHERE convert(nvarchar,TAS.PKCodigo_TBAtendimento) LIKE '" & txtConsulta.Text & "' "
       ElseIf cbbCampos.Text = "Descrição" Then
          strSQL = strSQL & " WHERE TAS.DFDescricao_Tipo_atendimento LIKE '%" & Funcoes_Gerais.Grava_String(txtConsulta.Text) & "%' "
       End If
    End If
    ...
    strSQL = strSQL & " ORDER BY TAS.Codigo"

    Movimentacoes.Movimenta_HFlex_Grid strSQL, hfgTipo_Atendimento_Servico, "1000,3500", "Código,Descrição", "BDRetaguarda", "Otica", Me

    hfgTipo_Atendimento_Servico.Col = 0
    hfgTipo_Atendimento_Servico.Row = 1
    If hfgTipo_Atendimento_Servico.Text = Empty Then
       hfgTipo_Atendimento_Servico.Rows = 2
       Movimentacoes.Monta_HFlex_Grid hfgTipo_Atendimento_Servico, "1000,3500", "Código,Descrição", 2, "Otica", Me
    End If
...
Private Function Integracao()
    ...
    Call frmIntegracao.Verifica_Integracao("PKCodigo_TBAtendimento", txtCodigo.Text, "DFIntegrado_filiais_TBTipo_atendimento_servico", "TBTipo_atendimento_servico", "Otica", "BDRetaguarda", "DFIntegrado_portal_TBTipo_atendimento_servico", Me.Top, Me.Left, Me.Width, Me.Height, "Tipo Atendimento Serviço")
