...
Begin VB.Form frmSoftware_Pendencias_Consulta_Empresa 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Empresa para Consulta Software Pendência"
   ClientHeight    =   735
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   6030
   ...
   EndProperty
   Icon            =   "frmSoftware_Pendencias_Consulta_Empresa.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   End
End
Attribute VB_Name = "frmSoftware_Pendencias_Consulta_Empresa"
...
' Sistema................: Only Tech                                                      '
' Módulo.................: Serviços                                                       '
' Objetivo...............: Empresa para Consulta Software Pendência                       '
...
Private Sub cmdOk_Click()
    ...
    If rstEmpresa_Codigo.RecordCount <> 0 Then
       frmSoftware_Pendencias.strCodigo_Empresa_Consulta = rstEmpresa_Codigo.Fields!PKCodigo_TBEmpresa
    Else
       frmSoftware_Pendencias.strCodigo_Empresa_Consulta = 0
    End If
