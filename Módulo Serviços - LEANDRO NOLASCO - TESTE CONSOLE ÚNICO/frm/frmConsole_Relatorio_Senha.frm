...
Begin VB.Form frmConsole_Relatorio_Senha 
   ...
   EndProperty
   Icon            =   "frmConsole_Relatorio_Senha.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.CommandButton cmdConfiguracao_relatorio 
      Height          =   795
      Left            =   11700
      Picture         =   "frmConsole_Relatorio_Senha.frx":1CCA
      Style           =   1  'Graphical
      TabIndex        =   3
   ...
   Begin VB.CommandButton cmdConfiguracao_impressora 
      Height          =   795
      Left            =   10710
      Picture         =   "frmConsole_Relatorio_Senha.frx":3994
      Style           =   1  'Graphical
      TabIndex        =   0
   ...
   End
End
Attribute VB_Name = "frmConsole_Relatorio_Senha"
...
Private Sub Form_Load()
    ...
    intTamanho_string = Len(frmRelatorio_Senha.strSql)
    inttamanho_From = InStr(1, frmRelatorio_Senha.strSql, "FROM")
    strSql_antes_from = Mid(frmRelatorio_Senha.strSql, 1, inttamanho_From - 1)
    strSql_pos_from = Mid(frmRelatorio_Senha.strSql, inttamanho_From, intTamanho_string)
    ...
    strCaminho = Funcoes_Gerais.Abrir_relatorio_registro("Otica", Me, "NF") & "\rptEmissao_Senha_Cliente.rpt"
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    frmRelatorio_Senha.optAtivos_Todos.Value = True
    frmRelatorio_Senha.optBloqueados_Todos.Value = True
