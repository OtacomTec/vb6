...
Begin VB.Form frmConsole_Marcha_Analitica 
   ...
   EndProperty
   Icon            =   "frmConsole_Marcha_Analitica.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form2"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin VB.CommandButton cmdConfiguracao_impressora 
      Height          =   795
      Left            =   10710
      Picture         =   "frmConsole_Marcha_Analitica.frx":038A
      Style           =   1  'Graphical
      TabIndex        =   1
   ...
   Begin VB.CommandButton cmdConfiguracao_relatorio 
      Height          =   795
      Left            =   11670
      Picture         =   "frmConsole_Marcha_Analitica.frx":2054
      Style           =   1  'Graphical
      TabIndex        =   0
   ...
   End
End
Attribute VB_Name = "frmConsole_Marcha_Analitica"
...
Private Sub Form_Load()
    ...
    intTamanho_string = Len(frmMarcha_Analitica.strSql)
    inttamanho_From = InStr(1, frmMarcha_Analitica.strSql, "FROM")
    strSql_antes_from = Mid(frmMarcha_Analitica.strSql, 1, inttamanho_From - 1)
    strSql_pos_from = Mid(frmMarcha_Analitica.strSql, inttamanho_From, intTamanho_string)
    ...
    strCaminho = Funcoes_Gerais.Abrir_relatorio_registro("Otica", Me) & "\rptInsumo.rpt"
