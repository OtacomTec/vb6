...
Begin VB.Form frmTipo_Servico 
   ...
   ScaleHeight     =   3015
   ScaleWidth      =   5205
   Begin TabDlg.SSTab sstTipo_Servico 
      Height          =   2685
      Left            =   0
      TabIndex        =   11
      Top             =   330
      ...
      EndProperty
      TabCaption(0)   =   "&Geral"
      TabPicture(0)   =   "frmTipo_Servico.frx":1782
      ...
      TabPicture(1)   =   "frmTipo_Servico.frx":179E
      Tab(1).ControlEnabled=   -1  'True
      Tab(1).Control(0)=   "Label6"
      Tab(1).Control(0).Enabled=   0   'False
      Tab(1).Control(1)=   "cbbCampos"
      Tab(1).Control(1).Enabled=   0   'False
      Tab(1).Control(2)=   "hfgTipo_Servico"
      ...
      Begin VB.CommandButton cmdRefresh 
         Height          =   360
         Left            =   4710
         Picture         =   "frmTipo_Servico.frx":17BA
         Style           =   1  'Graphical
         TabIndex        =   3
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton cmdConsulta 
         Height          =   360
         Left            =   4320
         Picture         =   "frmTipo_Servico.frx":27FC
         Style           =   1  'Graphical
         TabIndex        =   2
      ...
      Begin VB.TextBox txtCodigo 
         ...
         MaxLength       =   9
         TabIndex        =   0
         ToolTipText     =   "Código do Tipo Serviço"
         Top             =   810
         Width           =   1110
      End
      Begin VB.TextBox txtDescricao 
         ...
         MaxLength       =   40
         TabIndex        =   1
         ToolTipText     =   "Descrição do Tipo Serviço"
         Top             =   1440
         Width           =   4935
      End
      Begin MSHierarchicalFlexGridLib.MSHFlexGrid hfgTipo_Servico 
         Height          =   1365
         Left            =   120
         TabIndex        =   5
         Top             =   1200
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTipo_Servico.frx":44F6
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTipo_Servico.frx":4810
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTipo_Servico.frx":4B2A
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTipo_Servico.frx":4EC4
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTipo_Servico.frx":525E
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTipo_Servico.frx":5578
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTipo_Servico.frx":5892
            Key             =   ""
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "frmTipo_Servico"
...
' Sistema................: Only Tech                                                      '
' Módulo.................: Serviços                                                       '
' Objetivo...............: Cadastro Tipo de Serviço                                       '
...
Function Imprimir()
    ...
    Call frmConsole_Tipo_Servico.Show
...
Private Sub Form_Load()
    ...
    log.Programa = "Cadastro de Tipo Serviço"
    ...
    If MDIPrincipal.booDesign_time = False Then
       Call Movimentacoes.Acessibilidade_inicio(Me.Caption, cmdConsulta, cmdRefresh, Me.sstTipo_Servico, booPrivilegio_Incluir, booPrivilegio_Alterar, booPrivilegio_Excluir, booPrivilegio_Consultar, MDIPrincipal.OCXUsuario.Codigo, tlbBotoes, Me, "Otica", "BDRetaguarda")
    Else
    ...
    log.Descricao = "Inicializando o cadastro de Tipo Serviço"
    
    'Gravando o log
    log.Gravar_log "Otica", Me
    
    sstTipo_Servico.Tab = 1
    sstTipo_Servico.TabEnabled(0) = False
    Call Reposicao
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    log.Evento = "Unload"
    log.Hora = Format(Now, "hh:mm:ss")
    log.Descricao = "Finalizando o cadastro de Tipo Serviço"
    'Gravando Log
    log.Gravar_log "OTICA", Me
...
Private Sub hfgTipo_Servico_click()

   If hfgTipo_Servico.Col = 0 And hfgTipo_Servico.Text <> Empty Then
      ...
      txtCodigo.Text = hfgTipo_Servico.TextArray((hfgTipo_Servico.Row * hfgTipo_Servico.Cols + hfgTipo_Servico.Col + 1))
      txtDescricao.Text = hfgTipo_Servico.TextArray((hfgTipo_Servico.Row * hfgTipo_Servico.Cols + hfgTipo_Servico.Col + 2))
       
      booAlterar = True
      txtConsulta.Text = Empty
      sstTipo_Servico.TabEnabled(0) = True
      sstTipo_Servico.Tab = 0
...
Private Sub hfgTipo_Servico_DblClick()
   hfgTipo_Servico.Sort = 1
End Sub

Private Sub hfgTipo_Servico_KeyPress(KeyAscii As Integer)
    If KeyAscii = 32 Then
       Call hfgTipo_Servico_click
    End If
End Sub

Private Sub sstTipo_Servico_Click(PreviousTab As Integer)
   If sstTipo_Servico.Tab = 0 Then
      txtDescricao.SetFocus
   ElseIf sstTipo_Servico.Tab = 1 Then
      If frmIntegracao.Visible = True Then
         Unload frmIntegracao
      End If
      ...
      ElseIf strCombo = "Todos" Then
         hfgTipo_Servico.Row = 1
         hfgTipo_Servico.Col = 0
         hfgTipo_Servico.SetFocus
      End If
   End If
End Sub
...
Private Sub tlbBotoes_ButtonClick(ByVal Button As MSComctlLib.Button)
    Select Case Button.Index
           Case 1: Call Novo
           Case 2 And sstTipo_Servico.Tab <> 1: Call Gravar
...
Function Gravar()
    ...
    If txtCodigo.Text <> Empty And booAlterar = False Then
        Movimentacoes.Verifica_Numero "PKCodigo_Prioridade_TBTipo_Pendencia_servico", "TBTipo_servico_Pendencia_Servico", txtCodigo, "Otica", Me
    End If

    Call Objetos.Maiusculo_TXT(Me)
    
    strCampo = "PKCodigo_Prioridade_TBTipo_Pendencia_servico,DFDescricao_TBTipo_Pendencia_servico," & _
               "DFData_alteracao_TBTipo_servico_Pendencia_servico," & _
               "DFIntegrado_filiais_TBTipo_servico_Pendencia_servico "
               
    If booIntegra_Portal = True Then
        strCampo = strCampo & ",DFIntegrado_portal_TBTipo_servico_Pendencia_servico "
    End If
    ...
    If booAlterar = True Then
       ...
       strSet = "SET DFDescricao_TBTipo_Pendencia_servico = '" & Funcoes_Gerais.Grava_String(txtDescricao.Text) & "'," & _
                "DFData_alteracao_TBTipo_servico_Pendencia_servico = '" & Format(Date, "YYYYMMDD") & "'," & _
                "DFIntegrado_filiais_TBTipo_servico_Pendencia_servico = 0 "
                
       If booIntegra_Portal = True Then
          strSet = strSet & ",DFIntegrado_portal_TBTipo_servico_Pendencia_servico = 0"
       End If
                          
       Call funcoes_banco.Alterar("TBTipo_servico_Pendencia_servico", strSet, "PKCodigo_Prioridade_TBTipo_Pendencia_servico", txtCodigo.Text, "Otica", Me, "BDRetaguarda")
    ...
    Else
       ...
       Call funcoes_banco.Gravar("TBTipo_servico_Pendencia_servico", strCampo, strValores, "Otica", Me, "BDRetaguarda")
    ...
    If booPrivilegio_Consultar = False Then
       Me.hfgTipo_Servico.Visible = False
    End If
...
Private Function Excluir()
    ...
    strSql = "SELECT FKCodigo_TBTipo_servico_Pendencia_Servico,PKID_TBPendencia_servico FROM TBPendencia_servicos WHERE FKCodigo_TBTipo_servico_Pendencia_Servico = " & txtCodigo.Text & ""
    
    Select_geral strSql, "BDRetaguarda", rstAplicacao, "Otica", Me
    If rstAplicacao.RecordCount <> 0 Then
       MsgBox "Este Tipo de Serviço está vinculado a tabela Pendência no registro " & rstAplicacao.Fields("PKID_TBPendencia_servico") & " e não poderá ser excluída. Verifique.", vbInformation, "Only Tech"
    ...
    'Excluindo Registro
    Call funcoes_banco.Excluir("TBTipo_servico_Pendencia_Servico", "PKCodigo_Prioridade_TBTipo_Pendencia_servico", txtCodigo.Text, "Otica", Me, "BDRetaguarda")
...
Private Function Reposicao()
    ...
    Movimentacoes.Monta_HFlex_Grid hfgTipo_Servico, "1000,3500", "Código,Descrição", 2, "Otica", Me
...
Private Function Consulta()
    ...
    strSql = "SELECT TBTipo_servico_Pendencia_servico.PKCodigo_Prioridade_TBTipo_Pendencia_servico As Codigo,TBTipo_servico_Pendencia_servico.DFDescricao_TBTipo_Pendencia_servico As Descricao " & _
    ...
    If cbbCampos.Text <> "Todos" Then
       If cbbCampos.Text = "Código" Then
          strSql = strSql & " WHERE convert(nvarchar,TBTipo_servico_Pendencia_servico.PKCodigo_Prioridade_TBTipo_Pendencia_servico) = '" & txtConsulta.Text & "' "
       ElseIf cbbCampos.Text = "Descrição" Then
          strSql = strSql & " WHERE TBTipo_servico_Pendencia_servico.DFDescricao_TBTipo_Pendencia_servico LIKE '%" & txtConsulta.Text & "%' "
       End If
    End If
    ...
    strSql = strSql & " ORDER BY TBTipo_servico_Pendencia_servico.PKCodigo_Prioridade_TBTipo_Pendencia_servico"
       
    Movimentacoes.Movimenta_HFlex_Grid strSql, hfgTipo_Servico, "1000,3500", "Código,Descrição", "BDRetaguarda", "Otica", Me
    
    hfgTipo_Servico.Col = 0
    hfgTipo_Servico.Row = 1
    If hfgTipo_Servico.Text = Empty Then
       hfgTipo_Servico.Rows = 2
       Movimentacoes.Monta_HFlex_Grid hfgTipo_Servico, "1000,3500", "Código,Descrição", 2, "Otica", Me
    End If
...
Private Function Integracao()
    ...
    Call frmIntegracao.Verifica_Integracao("PKCodigo_Prioridade_TBTipo_Pendencia_servico", txtCodigo.Text, "DFIntegrado_filiais_TBTipo_servico_Pendencia_servico", "TBTipo_servico_Pendencia_servico", "Otica", "BDRetaguarda", "DFIntegrado_portal_TBTipo_servico_Pendencia_servico", Me.Top, Me.Left, Me.Width, Me.Height, "Tipo Serviço")
