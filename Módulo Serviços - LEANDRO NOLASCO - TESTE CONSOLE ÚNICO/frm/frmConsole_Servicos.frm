...
Begin VB.Form frmConsole_Servicos 
   ...
   ClientTop       =   330
   ClientWidth     =   12660
   Icon            =   "frmConsole_Servicos.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin VB.CommandButton cmdConfiguracao_impressora 
      Height          =   795
      Left            =   10740
      Picture         =   "frmConsole_Servicos.frx":1CCA
      Style           =   1  'Graphical
      TabIndex        =   1
   ...
   Begin VB.CommandButton cmdConfiguracao_relatorio 
      Height          =   795
      Left            =   11700
      Picture         =   "frmConsole_Servicos.frx":3994
      Style           =   1  'Graphical
      TabIndex        =   0
   ...
   End
End
Attribute VB_Name = "frmConsole_Servicos"
...
Private Sub Form_Load()
    ...
    intTamanho_string = Len(frmServicos.strSql)
    inttamanho_From = InStr(1, frmServicos.strSql, "FROM")
    strSql_antes_from = Mid(frmServicos.strSql, 1, inttamanho_From - 1)
    strSql_pos_from = Mid(frmServicos.strSql, inttamanho_From, intTamanho_string)
    ...
    strCaminho = Funcoes_Gerais.Abrir_relatorio_registro("Otica", Me) & "\rptServico_Laboratorio.rpt"
