...
Begin VB.Form frmConsole_Status_Pendencia 
   AutoRedraw      =   -1  'True
   ...
   EndProperty
   Icon            =   "frmConsole_Status_Pendencia.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.CommandButton cmdConfiguracao_relatorio 
      ...
      Height          =   795
      Left            =   11670
      Picture         =   "frmConsole_Status_Pendencia.frx":1CCA
      Style           =   1  'Graphical
      TabIndex        =   1
   ...
   Begin VB.CommandButton cmdConfiguracao_impressora 
      ...
      Height          =   795
      Left            =   10710
      Picture         =   "frmConsole_Status_Pendencia.frx":3994
      Style           =   1  'Graphical
      TabIndex        =   0
   ...
   End
End
Attribute VB_Name = "frmConsole_Status_Pendencia"
...
Private Sub Form_Load()
    ...
    intTamanho_string = Len(frmStatus_Pendencia.strSql)
    inttamanho_From = InStr(1, frmStatus_Pendencia.strSql, "FROM")
    strSql_antes_from = Mid(frmStatus_Pendencia.strSql, 1, inttamanho_From - 1)
    strSql_pos_from = Mid(frmStatus_Pendencia.strSql, inttamanho_From, intTamanho_string)
    ...
    strCaminho = Funcoes_Gerais.Abrir_relatorio_registro("Otica", Me) & "\rptStatus_Pendencia.rpt"
