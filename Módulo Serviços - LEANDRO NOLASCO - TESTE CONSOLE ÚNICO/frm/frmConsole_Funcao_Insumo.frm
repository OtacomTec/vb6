...
Begin VB.Form frmConsole_Funcao_Insumo 
   ...
   EndProperty
   Icon            =   "frmConsole_Funcao_Insumo.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form3"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin VB.CommandButton cmdConfiguracao_relatorio 
      Height          =   795
      Left            =   11640
      Picture         =   "frmConsole_Funcao_Insumo.frx":038A
      Style           =   1  'Graphical
      TabIndex        =   1
   ...
   Begin VB.CommandButton cmdConfiguracao_impressora 
      Height          =   795
      Left            =   10680
      Picture         =   "frmConsole_Funcao_Insumo.frx":2054
      Style           =   1  'Graphical
      TabIndex        =   0
   ...
   End
End
Attribute VB_Name = "frmConsole_Funcao_Insumo"
...
Private Sub Form_Load()
    ...
    intTamanho_string = Len(frmFuncao_Insumo.strSql)
    inttamanho_From = InStr(1, frmFuncao_Insumo.strSql, "FROM")
    strSql_antes_from = Mid(frmFuncao_Insumo.strSql, 1, inttamanho_From - 1)
    strSql_pos_from = Mid(frmFuncao_Insumo.strSql, inttamanho_From, intTamanho_string)
    ...
    strCaminho = Funcoes_Gerais.Abrir_relatorio_registro("Otica", Me) & "\rptFuncao_Insumo.rpt"
