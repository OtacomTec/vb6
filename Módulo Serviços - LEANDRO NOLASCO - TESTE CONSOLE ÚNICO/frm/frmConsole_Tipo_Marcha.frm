...
Begin VB.Form frmConsole_Tipo_Marcha 
   ...
   EndProperty
   Icon            =   "frmConsole_Tipo_Marcha.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.CommandButton cmdConfiguracao_relatorio 
      Height          =   795
      Left            =   11640
      Picture         =   "frmConsole_Tipo_Marcha.frx":038A
      Style           =   1  'Graphical
      TabIndex        =   1
   ...
   Begin VB.CommandButton cmdConfiguracao_impressora 
      Height          =   795
      Left            =   10680
      Picture         =   "frmConsole_Tipo_Marcha.frx":2054
      Style           =   1  'Graphical
      TabIndex        =   0
   ...
   End
End
Attribute VB_Name = "frmConsole_Tipo_Marcha"
...
Private Sub Form_Load()
    ...
    intTamanho_string = Len(frmTipo_Marcha.strSql)
    inttamanho_From = InStr(1, frmTipo_Marcha.strSql, "FROM")
    strSql_antes_from = Mid(frmTipo_Marcha.strSql, 1, inttamanho_From - 1)
    strSql_pos_from = Mid(frmTipo_Marcha.strSql, inttamanho_From, intTamanho_string)
    ...
    strCaminho = Funcoes_Gerais.Abrir_relatorio_registro("Otica", Me) & "\rptTipo_Marcha.rpt"
