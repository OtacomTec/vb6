...
Begin VB.Form frmConsole_Tipo_Servico 
   ...
   EndProperty
   Icon            =   "frmConsole_Tipo_Servico.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.CommandButton cmdConfiguracao_relatorio 
      Height          =   795
      Left            =   11670
      Picture         =   "frmConsole_Tipo_Servico.frx":1CCA
      Style           =   1  'Graphical
      TabIndex        =   1
   ...
   Begin VB.CommandButton cmdConfiguracao_impressora 
      Height          =   795
      Left            =   10710
      Picture         =   "frmConsole_Tipo_Servico.frx":3994
      Style           =   1  'Graphical
      TabIndex        =   0
   ...
   End
End
Attribute VB_Name = "frmConsole_Tipo_Servico"
...
Private Sub Form_Load()
    ...
    intTamanho_string = Len(frmTipo_Servico.strSql)
    inttamanho_From = InStr(1, frmTipo_Servico.strSql, "FROM")
    strSql_antes_from = Mid(frmTipo_Servico.strSql, 1, inttamanho_From - 1)
    strSql_pos_from = Mid(frmTipo_Servico.strSql, inttamanho_From, intTamanho_string)
    ...
    strCaminho = Funcoes_Gerais.Abrir_relatorio_registro("Otica", Me) & "\rptTipo_Servico.rpt"
