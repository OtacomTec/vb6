...
Begin VB.Form frmConsole_Software_Pendencias 
   AutoRedraw      =   -1  'True
   ...
   EndProperty
   Icon            =   "frmConsole_Software_Pendencias.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.CommandButton cmdConfiguracao_relatorio 
      Height          =   795
      Left            =   11670
      Picture         =   "frmConsole_Software_Pendencias.frx":1CCA
      Style           =   1  'Graphical
      TabIndex        =   1
   ...
   Begin VB.CommandButton cmdConfiguracao_impressora 
      Height          =   795
      Left            =   10710
      Picture         =   "frmConsole_Software_Pendencias.frx":3994
      Style           =   1  'Graphical
      TabIndex        =   0
   ...
   End
End
Attribute VB_Name = "frmConsole_Software_Pendencias"
...
Private Sub Form_Load()
    ...
    intTamanho_string = Len(frmSoftware_Pendencias.strSql)
    inttamanho_From = InStr(1, frmSoftware_Pendencias.strSql, "FROM")
    strSql_antes_from = Mid(frmSoftware_Pendencias.strSql, 1, inttamanho_From - 1)
    strSql_pos_from = Mid(frmSoftware_Pendencias.strSql, inttamanho_From, intTamanho_string)
    ...
    strCaminho = Funcoes_Gerais.Abrir_relatorio_registro("Otica", Me) & "\rptSoftware_Pendencias.rpt"
