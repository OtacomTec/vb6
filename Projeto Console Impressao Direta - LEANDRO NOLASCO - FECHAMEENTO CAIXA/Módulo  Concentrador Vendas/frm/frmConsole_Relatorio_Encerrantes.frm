...
Begin VB.Form frmConsole_Relatorio_Encerrantes 
   ...
   EndProperty
   Icon            =   "frmConsole_Relatorio_Encerrantes.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.CommandButton cmdConfiguracao_impressora 
      Height          =   795
      Left            =   10710
      Picture         =   "frmConsole_Relatorio_Encerrantes.frx":1782
      Style           =   1  'Graphical
      TabIndex        =   1
   ...
   Begin VB.CommandButton cmdConfiguracao_relatorio 
      Height          =   795
      Left            =   11670
      Picture         =   "frmConsole_Relatorio_Encerrantes.frx":344C
      Style           =   1  'Graphical
      TabIndex        =   0
   ...
   End
End
Attribute VB_Name = "frmConsole_Relatorio_Encerrantes"
...
Private Sub Form_Load()
    ...
    intTamanho_string = Len(frmRelatorio_Encerrante.strSql)
    inttamanho_From = InStr(1, frmRelatorio_Encerrante.strSql, "FROM")
    strSql_antes_from = Mid(frmRelatorio_Encerrante.strSql, 1, inttamanho_From - 1)
    strSql_pos_from = Mid(frmRelatorio_Encerrante.strSql, inttamanho_From, intTamanho_string)
    ...
    strCaminho = Funcoes_Gerais.Abrir_relatorio_registro("Otica", Me) & "\rptEncerrente_Dia.rpt"
