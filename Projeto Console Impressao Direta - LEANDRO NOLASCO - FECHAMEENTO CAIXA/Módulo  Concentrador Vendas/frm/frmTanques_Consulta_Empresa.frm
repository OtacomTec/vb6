...
Begin VB.Form frmTanques_Consulta_Empresa 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Empresa para Consulta Tanque"
   ClientHeight    =   750
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   6030
   ...
   EndProperty
   Icon            =   "frmTanques_Consulta_Empresa.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "frmTanques_Consulta_Empresa"
...
' Sistema................: Only Tech                                                      '
' Módulo.................: Compras                                                        '
' Objetivo...............: Empresa para Consulta Tanque                                   '
...
Private Sub cmdOk_Click()
    ...
    If rstEmpresa_Codigo.RecordCount <> 0 Then
       frmTanques.strCodigo_Empresa_Consulta = rstEmpresa_Codigo.Fields!PKCodigo_TBEmpresa
    Else
       frmTanques.strCodigo_Empresa_Consulta = 0
    End If
