...
Private Sub cmdOk_Click()
  ...
  If frmConta_Corrente.STRNOME_BOTAO = "cmdArquivo_Remessa" Then
     frmConta_Corrente.txtPath_Arq_Remessa.Text = txtCaminho.Text
  End If
  
  If frmConta_Corrente.STRNOME_BOTAO = "cmdArquivo_Retorno" Then
     frmConta_Corrente.txtPath_Arq_Retorno.Text = txtCaminho.Text
  End If
