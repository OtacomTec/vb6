   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmImpressora_Ecf.frx":5892
            Key             =   ""
         EndProperty
      EndProperty
   End
...
Private Sub hfgImpressora_DblClick()
    hfgImpressora.Sort = 1
End Sub
...
Function Gravar()
    ...
    strCampo = "PKCodigo_TBImpressoras_ecf,DFNome_TBImpressoras_ecf,DFVersao_TBImpressoras_ecf," & _
               "DFData_alteracao_TBImpressoras_ecf,DFIntegrado_filiais_TBImpressoras_ecf"
               
    If booIntegra_Portal = True Then
       strCampo = strCampo & ",DFIntegrado_portal_TBImpressoras_ecf"
    End If
    
    strValores = " " & txtCodigo & "," & _
                 "'" & Funcoes_Gerais.Grava_String(txtNome.Text) & "'," & _
                 "'" & Funcoes_Gerais.Grava_String(txtVersao.Text) & "'," & _
    ...
    If booAlterar = True Then
       ...
       strSet = "SET DFNome_TBImpressoras_ecf = '" & Funcoes_Gerais.Grava_String(txtNome.Text) & "'," & _
                "    DFVersao_TBImpressoras_ecf = '" & Funcoes_Gerais.Grava_String(txtVersao.Text) & "'," & _
                "    DFData_alteracao_TBImpressoras_ecf = '" & Format(Date, "YYYYMMDD") & "'," & _
                "    DFIntegrado_filiais_TBImpressoras_ecf = 0"
        
       If booIntegra_Portal = True Then
          strSet = strSet & ",DFIntegrado_portal_TBImpressoras_ecf = 0"
       End If
...
Private Function Integracao()
    ...
    Call frmIntegracao.Verifica_Integracao("PKCodigo_TBImpressoras_ecf", txtCodigo.Text, "DFIntegrado_filiais_TBImpressoras_ecf", "TBImpressoras_ecf", "Otica", "BDRetaguarda", "DFIntegrado_portal_TBImpressoras_ecf", Me.Top, Me.Left, Me.width, Me.Height, "Impressoras ECF")
