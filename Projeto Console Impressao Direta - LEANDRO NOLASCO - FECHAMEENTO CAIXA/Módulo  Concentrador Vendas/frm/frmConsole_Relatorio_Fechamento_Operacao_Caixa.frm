...
Begin VB.Form frmConsole_Relatorio_Fechamento_Operacao_Caixa 
   ...
   Caption         =   "Relatório de fechamento de operacao de caixa"
   ClientHeight    =   7830
   ClientLeft      =   330
   ClientTop       =   540
   ClientWidth     =   12600
...
Private Sub Form_Load()
    ...
    If frmRelatorio_Operacao_Caixa.optAnalitico.Value = True Then
       If frmRelatorio_Operacao_Caixa.optPDV.Value = True Then
          If frmRelatorio_Operacao_Caixa.lblAuditoria.Visible = True Then
             strCaminho = Funcoes_Gerais.Abrir_relatorio_registro("Otica", Me) & "\rptFechamento_operacao_caixa_pdv_auditoria.rpt"
          End If
          If frmRelatorio_Operacao_Caixa.lblAuditoria.Visible = False Then
       ...
       ElseIf frmRelatorio_Operacao_Caixa.optFinalizadora.Value = True Then
          If frmRelatorio_Operacao_Caixa.lblAuditoria.Visible = True Then
             strCaminho = Funcoes_Gerais.Abrir_relatorio_registro("Otica", Me) & "\rptFechamento_operacao_caixa_finalizadora_auditoria.rpt"
          End If
          If frmRelatorio_Operacao_Caixa.lblAuditoria.Visible = False Then
       ...
       ElseIf frmRelatorio_Operacao_Caixa.optData.Value = True Then
          If frmRelatorio_Operacao_Caixa.lblAuditoria.Visible = True Then
             strCaminho = Funcoes_Gerais.Abrir_relatorio_registro("Otica", Me) & "\rptFechamento_operacao_caixa_dia_auditoria.rpt"
          End If
          If frmRelatorio_Operacao_Caixa.lblAuditoria.Visible = False Then
       ...
       ElseIf frmRelatorio_Operacao_Caixa.optOperador.Value = True Then
          If frmRelatorio_Operacao_Caixa.lblAuditoria.Visible = True Then
             strCaminho = Funcoes_Gerais.Abrir_relatorio_registro("Otica", Me) & "\rptFechamento_operacao_caixa_operador_auditoria.rpt"
          End If
          If frmRelatorio_Operacao_Caixa.lblAuditoria.Visible = False Then
       ...
       ElseIf frmRelatorio_Operacao_Caixa.optFaixa_Horaria.Value = True Then
          If frmRelatorio_Operacao_Caixa.lblAuditoria.Visible = True Then
             If frmRelatorio_Operacao_Caixa.lblAuditoria.Visible = True Then
                strCaminho = Funcoes_Gerais.Abrir_relatorio_registro("Otica", Me) & "\rptFechamento_operacao_caixa_dia_faixa_horaria_auditoria.rpt"
             End If
             If frmRelatorio_Operacao_Caixa.lblAuditoria.Visible = False Then
    ...
    Else
       If frmRelatorio_Operacao_Caixa.optFinalizadora_Periodo.Value = True Then
          If frmRelatorio_Operacao_Caixa.lblAuditoria.Visible = True Then
             strCaminho = Funcoes_Gerais.Abrir_relatorio_registro("Otica", Me) & "\rptFechamento_operacao_caixa_finalizadora_periodo_sintetico_auditoria.rpt"
          End If
          If frmRelatorio_Operacao_Caixa.lblAuditoria.Visible = False Then
       ...
       ElseIf frmRelatorio_Operacao_Caixa.optFinalizadora.Value = True Then
          ...
          End If
          If frmRelatorio_Operacao_Caixa.lblAuditoria.Visible = False Then
             strCaminho = Funcoes_Gerais.Abrir_relatorio_registro("Otica", Me) & "\rptFechamento_operacao_caixa_finalizadora_sintetico_auditoria.rpt"
          End If
       End If
    End If
    ...
    ElseIf frmRelatorio_Operacao_Caixa.optFaixa_Horaria.Value = True Then
       Relatorio.FormulaFields.GetItemByName("Tipo_relatorio").Text = "'" + "por Faixa Horária" + "'"
    ElseIf frmRelatorio_Operacao_Caixa.optFinalizadora_Periodo.Value = True Then
       Relatorio.FormulaFields.GetItemByName("Tipo_relatorio").Text = "'" + "por Finalizadora Período" + "'"
