...
Begin VB.Form frmConsole_Relatorio_Pdv 
   ...
   Begin VB.CommandButton cmdConfiguracao_impressora 
      ...
      Height          =   795
      Left            =   10710
      Picture         =   "frmConsole_Pdv.frx":038A
      Style           =   1  'Graphical
      TabIndex        =   1
   ...
   Begin VB.CommandButton cmdConfiguracao_relatorio 
      ...
      Height          =   795
      Left            =   11670
      Picture         =   "frmConsole_Pdv.frx":2054
      Style           =   1  'Graphical
      TabIndex        =   0
   ...
   End
End
Attribute VB_Name = "frmConsole_Relatorio_Pdv"
...
Private Sub Form_Load()
    ...
    intTamanho_string = Len(frmPdv.strsql)
    inttamanho_From = InStr(1, frmPdv.strsql, "FROM")
    strSql_antes_from = Mid(frmPdv.strsql, 1, inttamanho_From - 1)
    strSql_pos_from = Mid(frmPdv.strsql, inttamanho_From, intTamanho_string)
    ...
    strCaminho = Funcoes_Gerais.Abrir_relatorio_registro("Otica", Me) & "\rptPdv.rpt"
