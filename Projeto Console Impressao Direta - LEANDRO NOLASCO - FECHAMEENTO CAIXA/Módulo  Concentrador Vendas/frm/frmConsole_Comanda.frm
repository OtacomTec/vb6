...
Begin VB.Form frmConsole_Relatorio_Comanda 
   ...
   EndProperty
   Icon            =   "frmConsole_Comanda.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.CommandButton cmdConfiguracao_impressora 
      ...
      Height          =   795
      Left            =   10710
      Picture         =   "frmConsole_Comanda.frx":038A
      Style           =   1  'Graphical
      TabIndex        =   1
   ...
   Begin VB.CommandButton cmdConfiguracao_relatorio 
      ...
      Height          =   795
      Left            =   11670
      Picture         =   "frmConsole_Comanda.frx":2054
      Style           =   1  'Graphical
      TabIndex        =   0
   ...
   End
End
Attribute VB_Name = "frmConsole_Relatorio_Comanda"
...
Private Sub Form_Load()
    ...
    intTamanho_string = Len(frmComanda.strsql)
    inttamanho_From = InStr(1, frmComanda.strsql, "FROM")
    strSql_antes_from = Mid(frmComanda.strsql, 1, inttamanho_From - 1)
    strSql_pos_from = Mid(frmComanda.strsql, inttamanho_From, intTamanho_string)
    ...
    strCaminho = Funcoes_Gerais.Abrir_relatorio_registro("Otica", Me) & "\rptComanda.rpt"
