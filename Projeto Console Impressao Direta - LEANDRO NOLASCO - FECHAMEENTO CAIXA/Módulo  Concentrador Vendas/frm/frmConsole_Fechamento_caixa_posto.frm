...
Begin VB.Form frmConsole_Fechamento_caixa_posto 
   ...
   EndProperty
   Icon            =   "frmConsole_Fechamento_caixa_posto.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin VB.CommandButton cmdConfiguracao_impressora 
      ...
      Height          =   795
      Left            =   10710
      Picture         =   "frmConsole_Fechamento_caixa_posto.frx":1CCA
      Style           =   1  'Graphical
      TabIndex        =   1
   ...
   Begin VB.CommandButton cmdConfiguracao_relatorio 
      ...
      Height          =   795
      Left            =   11670
      Picture         =   "frmConsole_Fechamento_caixa_posto.frx":3994
      Style           =   1  'Graphical
      TabIndex        =   0
   ...
   End
End
Attribute VB_Name = "frmConsole_Fechamento_caixa_posto"
...
Private Sub Form_Load()
    ...
    intTamanho_string = Len(frmFechamento_caixa_posto.strSql)
    inttamanho_From = InStr(1, frmFechamento_caixa_posto.strSql, "FROM")
    strSql_antes_from = Mid(frmFechamento_caixa_posto.strSql, 1, inttamanho_From - 1)
    strSql_pos_from = Mid(frmFechamento_caixa_posto.strSql, inttamanho_From, intTamanho_string)
    ...
    strCaminho = Funcoes_Gerais.Abrir_relatorio_registro("Otica", Me) & "\rptFechamento_caixa_posto.rpt"
