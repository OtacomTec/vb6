VERSION 5.00
Begin VB.Form frmMovimentacoes_Gera_Integracao_Frente_Loja_Caminho 
   ...
   EndProperty
   Icon            =   "frmMovimentacoes_Gera_Integracao_Frente_Loja_Caminho.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   End
End
Attribute VB_Name = "frmMovimentacoes_Gera_Integracao_Frente_Loja_Caminho"
...
Private Sub cmdOk_Click()
  frmMovimentacoes_Gera_Integracao_Frente_Loja.txtCaminho.Text = txtCaminho.Text
