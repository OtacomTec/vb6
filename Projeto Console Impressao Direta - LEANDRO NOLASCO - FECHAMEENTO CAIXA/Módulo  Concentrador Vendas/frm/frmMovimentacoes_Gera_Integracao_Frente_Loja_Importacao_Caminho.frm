VERSION 5.00
Begin VB.Form frmMovimentacoes_Gera_Integracao_Frente_Loja_Importacao_Caminho 
   ...
   EndProperty
   Icon            =   "frmMovimentacoes_Gera_Integracao_Frente_Loja_Importacao_Caminho.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmdLimpar 
         ...
         Left            =   5370
         TabIndex        =   3
         ToolTipText     =   "Limpa o caminho do Arquivo"
         Top             =   3210
         Width           =   1245
      End
   ...
   End
End
Attribute VB_Name = "frmMovimentacoes_Gera_Integracao_Frente_Loja_Importacao_Caminho"
...
Private Sub cmdOk_Click()
  frmMovimentacoes_Gera_Integracao_Frente_Loja_Importacao.txtCaminho.Text = txtCaminho.Text
