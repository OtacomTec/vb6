...
Public Impressao As New clsImpressao
Public Const wNomeSistema = "Only Tech"
...
Public Function Retira_Espaco_Lateral(Form As Form) As String

  For I = 0 To Form.Count - 1
      On Error Resume Next
      If (TypeOf Form.Controls(I) Is TextBox) Or (TypeOf Form.Controls(I) Is ComboBox) _
      Or (TypeOf Form.Controls(I) Is DataCombo) Then
            Form.Controls(I).Text = Trim(Form.Controls(I).Text)
      End If
  Next I
