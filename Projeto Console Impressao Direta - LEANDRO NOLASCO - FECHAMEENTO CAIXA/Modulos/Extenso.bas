...
'****************************************************************************************
Public Function gsFormatarExtenso(rcValor As Currency, Optional Sem_Acento As Boolean) As String
    ...
    'MODIFICAÇÃO PARA CORRIGIR PROBLEMAS DE ACENTUAÇÃO EM IMPRESSORA MATRICIAL - JONES - 4/11/2005
    If Sem_Acento = True Then
       Unidades(3) = "Tres": Unidades(4) = "Quatro": Unidades(5) = "Cinco"
    Else
    ...
    'MODIFICAÇÃO PARA CORRIGIR PROBLEMAS DE ACENTUAÇÃO EM IMPRESSORA MATRICIAL - JONES - 4/11/2005
    If Sem_Acento = True Then
       Quantia(1) = " ": Quantia(2) = " Mil ": Quantia(3) = " Milhoes "
    Else
