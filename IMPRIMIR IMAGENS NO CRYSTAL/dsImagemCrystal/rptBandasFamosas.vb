...
Public Class rptBandasFamosas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "dsImageReport.rptBandasFamosas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBandasFamosas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBandasFamosas = New rptBandasFamosas
        rpt.Site = Me.Site
        Return rpt
    End Function
