...
Begin VB.Form frmVendedores 
   ...
   Begin MSComctlLib.Toolbar tlbBotoes 
      ...
      EndProperty
   End
   Begin TabDlg.SSTab sstVendedor 
      Height          =   2955
      Left            =   0
      TabIndex        =   3
      Top             =   330
      ...
      TabHeight       =   520
      OLEDropMode     =   1
      MouseIcon       =   "frmVendedores.frx":030A
      ...
      EndProperty
      TabCaption(0)   =   "Geral"
      TabPicture(0)   =   "frmVendedores.frx":0326
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "txtPercentual"
      Tab(0).Control(1)=   "txtNome"
      ...
      TabPicture(1)   =   "frmVendedores.frx":0342
      Tab(1).ControlEnabled=   -1  'True
      Tab(1).Control(0)=   "Label6"
      Tab(1).Control(0).Enabled=   0   'False
      Tab(1).Control(1)=   "txtConsulta"
      Tab(1).Control(1).Enabled=   0   'False
      Tab(1).Control(2)=   "hfgVendedor"
      ...
      Begin VB.Image Image1 
         Height          =   2040
         Left            =   -3360
         Picture         =   "frmVendedores.frx":035E
         Top             =   -4200
         Width           =   5145
      End
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmVendedores.frx":2D3D
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmVendedores.frx":3057
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmVendedores.frx":3371
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmVendedores.frx":370B
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmVendedores.frx":3AA5
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmVendedores.frx":3DBF
            Key             =   ""
         EndProperty
      EndProperty
   End
...
' Módulo.................: Cadastros                                                      '
' Objetivo...............: Cadastrar de Vendedores                                        '
...
Private Sub hfgVendedor_Click()

    If hfgVendedor.Col > 0 Then
       strCampo_consulta = hfgVendedor.DataField(0, hfgVendedor.ColSel - 1)
    ...
    If hfgVendedor.Col = 0 Then
       ...
       txtCodigo.Text = hfgVendedor.TextArray((hfgVendedor.Row * hfgVendedor.Cols + hfgVendedor.Col + 1))
       txtNome.Text = hfgVendedor.TextArray((hfgVendedor.Row * hfgVendedor.Cols + hfgVendedor.Col + 2))
       txtPercentual.Text = Format(hfgVendedor.TextArray((hfgVendedor.Row * hfgVendedor.Cols + hfgVendedor.Col + 3)), "##0.0##")
...
'   strUsuario_log = MDIPrincipal_Cadastro_Base.UsuárioOCX.NomeReduzido
    ...
    log.Usuario = "Adão"
    log.Programa = "Cadastro de Vendedores"
...
Function Gravar()
    ...
    strCampo = "PKCodigo_TBVendedor,DFNome_TBVendedor,DFPercentual_comissao_TBVendedor"
    strvalores = " " & txtCodigo.Text & " , '" & txtNome.Text & "' , " & Funcoes_Gerais.Grava_Moeda(txtPercentual) & " "
    
    If booAlterar = True Then
       log.Evento = "Alterar"
       strSet = "SET DFNome_TBVendedor = '" & Me.txtNome.Text & "' , " & _
                "    DFPercentual_comissao_TBVendedor = " & Funcoes_Gerais.Grava_Moeda(txtPercentual) & " "
       Call funcoes_banco.Alterar("TBVendedor", strSet, "PKCodigo_TBVendedor", txtCodigo.Text, "PDV", Me, "BDSupervisor")
    ...
    Else
       ...
       Call funcoes_banco.Gravar("TBVendedor", strCampo, strvalores, "PDV", Me, "BDSupervisor")
...
Private Function Excluir()
    ...
    'Excluindo Registro
    Call funcoes_banco.Excluir("TBVendedor", "PKCodigo_TBVendedor", txtCodigo.Text, "PDV", Me, "BDSupervisor")
...
Private Sub txtCodigo_LostFocus()
    Movimentacoes.Verifica_Numero "PKCodigo_TBvendedor", "TBVendedor", txtCodigo, "PDV", Me
End Sub
...
Private Function Reposicao()
    ...
    strSQL = "SELECT * FROM TBVendedor"
    
    If txtConsulta.Text <> Empty Then
        strSQL = strSQL & " WHERE " & strCampo_consulta & " LIKE '" & txtConsulta.Text & "%' "
    End If

    Movimentacoes.Movimenta_HFlex_Grid strSQL, hfgVendedor, "800,3000,1000", "Código,Nome,Percentual", "BDSupervisor", "PDV", Me
...
Private Sub txtPercentual_LostFocus()
    ...
    txtPercentual.Text = Format(txtPercentual.Text, "###.00")
