...
Begin VB.Form frmSubgrupo 
   ...
   Begin MSComctlLib.Toolbar tlbBotoes 
      ...
      EndProperty
   End
   Begin TabDlg.SSTab sstSubgrupo 
      Height          =   2925
      Left            =   0
      TabIndex        =   5
      Top             =   330
      ...
      TabHeight       =   520
      OLEDropMode     =   1
      MouseIcon       =   "frmsubgrupo.frx":030A
      ...
      EndProperty
      TabCaption(0)   =   "Geral"
      TabPicture(0)   =   "frmsubgrupo.frx":0326
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "dtcGrupo"
      Tab(0).Control(1)=   "txtCodigo_grupo"
      ...
      TabPicture(1)   =   "frmsubgrupo.frx":0342
      Tab(1).ControlEnabled=   -1  'True
      Tab(1).Control(0)=   "Label6"
      Tab(1).Control(0).Enabled=   0   'False
      Tab(1).Control(1)=   "txtConsulta"
      Tab(1).Control(1).Enabled=   0   'False
      Tab(1).Control(2)=   "hfgSubgrupo"
      Tab(1).Control(2).Enabled=   0   'False
      Tab(1).ControlCount=   3
      Begin MSHierarchicalFlexGridLib.MSHFlexGrid hfgSubgrupo 
         Height          =   1605
         Left            =   120
         TabIndex        =   11
         Top             =   1170
      ...
      Begin MSDataListLib.DataCombo dtcGrupo 
         ...
         EndProperty
      End
      Begin VB.TextBox txtCodigo_grupo 
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9.75
            Charset         =   0
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsubgrupo.frx":2D3D
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsubgrupo.frx":3057
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsubgrupo.frx":3371
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsubgrupo.frx":370B
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsubgrupo.frx":3AA5
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsubgrupo.frx":3DBF
            Key             =   ""
         EndProperty
      EndProperty
   End
...
' Módulo.................: Cadastros                                                      '
' Objetivo...............: Cadastrar de Subgrupo                                          '
...
Private Sub hfgSubgrupo_Click()

    If hfgSubgrupo.Col > 0 Then
       strCampo_consulta = hfgSubgrupo.DataField(0, hfgSubgrupo.ColSel - 1)
    ...
    If hfgSubgrupo.Col = 0 Then
       ...
       txtCodigo.Text = hfgSubgrupo.TextArray((hfgSubgrupo.Row * hfgSubgrupo.Cols + hfgSubgrupo.Col + 1))
       txtDescricao.Text = hfgSubgrupo.TextArray((hfgSubgrupo.Row * hfgSubgrupo.Cols + hfgSubgrupo.Col + 2))
       txtCodigo_grupo.Text = hfgSubgrupo.TextArray((hfgSubgrupo.Row * hfgSubgrupo.Cols + hfgSubgrupo.Col + 3))
...
Private Sub dtcGrupo_Click(Area As Integer)
    txtCodigo_grupo = dtcGrupo.BoundText
End Sub
...
'   strUsuario_log = MDIPrincipal_Cadastro_Base.UsuárioOCX.NomeReduzido
    ...
    log.Usuario = "Adão"
    log.Programa = "Cadastro de Subgrupo"
...
Function Gravar()
    ...
    strCampo = "PKCodigo_TBSubgrupo,DFDescricao_TBSubgrupo,FKCodigo_TBGrupo"
    strvalores = " " & txtCodigo & " , '" & txtDescricao.Text & "'," & txtCodigo_grupo.Text & ""
    
    If booAlterar = True Then
       log.Evento = "Alterar"
       strSet = "SET DFDescricao_TBSubgrupo = '" & Me.txtDescricao.Text & "',FKCodigo_TBGrupo = " & txtCodigo_grupo.Text & " "
       Call funcoes_banco.Alterar("TBSubgrupo", strSet, "PKCodigo_TBSubgrupo", txtCodigo.Text, "PDV", Me, "BDSupervisor")
    ...
    Else
       ...
       Call funcoes_banco.Gravar("TBSubgrupo", strCampo, strvalores, "PDV", Me, "BDSupervisor")
...
Private Function Excluir()
    ...
    'Excluindo Registro
    Call funcoes_banco.Excluir("TBSubgrupo", "PKCodigo_TBSubgrupo", txtCodigo.Text, "PDV", Me, "BDSupervisor")
...
Private Sub txtCodigo_grupo_Change()
    dtcGrupo.BoundText = txtCodigo_grupo.Text
End Sub
Private Sub txtCodigo_LostFocus()
      Movimentacoes.Verifica_Numero "PKCodigo_TBSubgrupo", "TBSubgrupo", txtCodigo, "PDV", Me
End Sub
Private Function Reposicao()
    ...
    strSQL = "SELECT TBSubgrupo.PKCODIGO_TBSubgrupo,TBSubgrupo.DFDESCRICAO_TBSubgrupo,TBSubgrupo.FKCODIGO_TBGrupo, TBGrupo.DFDESCRICAO_TBGrupo " & _
             "FROM TBSubgrupo " & _
             "INNER JOIN TBGrupo " & _
             "ON TBSubgrupo.FKCODIGO_TBGrupo = TBGrupo.PKCODIGO_TBGrupo"
    
    If txtConsulta.Text <> Empty Then
        strSQL = strSQL & " WHERE " & strCampo_consulta & " LIKE '" & txtConsulta.Text & "%' "
    End If

    Movimentacoes.Movimenta_HFlex_Grid strSQL, hfgSubgrupo, "800,3000,0,3000", "Código,Codigo da Seção,Descrição,Seção", "BDSupervisor", "PDV", Me
     
    strSQL = "SELECT * FROM TBGrupo"
    'montando combo de seção'
    Call Movimentacoes.Movimenta_DataCombo("PKCodigo_TBGrupo", "DFDescricao_TBGrupo", dtcGrupo, strSQL, "BDSupervisor", "PDV", Me)
