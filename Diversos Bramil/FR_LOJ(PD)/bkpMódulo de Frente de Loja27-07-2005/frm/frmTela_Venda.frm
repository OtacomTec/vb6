...
Private Sub Form_Load()
    ...
    If frmTela_Venda.booCupom_fiscal = True And strImpresora = "Bematech" And frmTela_Venda.intImpressoes_suportadas <> 1 Then
...
Private Function Cancela_cupom()
    ...
    Else
        ...
        Serie = rstNumero_orcamento!DFProximo_serie_orcamento_balcao_TBParametros_ecf - 1
    End If
    ...
    If booIntegracao_Retaguarda = True Then
        ...
        strSql = "SELECT PKId_TBTitulo_receber FROM TBTitulo_receber " & _
                 ...
                 "DFSerie_TBTitulo_receber = '" & Serie & "'"
        ...
        strSql = Empty
        strSql = "SELECT * FROM TBNota_saida WHERE DFNumero_TBNota_saida = " & Nota & " AND DFSerie_TBNota_saida = '" & Serie & "'"
        ...
        strSql = "DELETE FROM TBTitulo_recebido " & _
                 "WHERE FKId_TBTitulo_receber = " & rstTitulos_Receber.Fields("PKId_TBTitulo_receber") & " "
        'Gravando
        CNconexao_cancelamento.CNconexao.Execute strSql
