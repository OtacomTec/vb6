...
Private Sub Form_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    If KeyCode = 115 Then
       ...
       If Me.txtPreco_total_cupom.Text > 0 Then
          Call Finaliza_Cupom
       End If
       txtCodigo_Produto.SetFocus
       Me.txtStatus.Text = "Aguardando Venda...."
...
Private Sub Form_Load()
    ...
    strImpresora = Comandos_impressoras_fiscais.Fabricante_Sweda
...
Private Function Processando_item()
     ...
     If frmTela_Venda.booCupom_fiscal = True Then
        ...
        If HflexGrid.Rows < 3 And frmTela_Venda.intImpressoes_suportadas <> 2 Then
           Comandos_impressoras_fiscais.Abre_Cupom (strImpresora)
        End If
        
        If frmTela_Venda.booCupom_fiscal = True And frmTela_Venda.intImpressoes_suportadas <> 2 Then
           Call Comandos_impressoras_fiscais.Vende_Item(strImpresora, CLng(strCodigo_Produto), strDescricao_Produto, CDbl(strQuantiade_imp), CDbl(strValor_Unitario_imp), CLng(strAliquota), CInt(strCasas_Decimais), strTipo_desconto, CDbl(strValor_desconto), strTipo_quantidade)
        End If
