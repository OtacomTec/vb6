...
Begin VB.Form frmConsole_Operacao_Caixa 
   ...
   EndProperty
   Icon            =   "frmConsole_Operacao_Caixa.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin VB.CommandButton cmdConfiguracao_impressora 
      ...
      Height          =   795
      Left            =   10710
      Picture         =   "frmConsole_Operacao_Caixa.frx":038A
      Style           =   1  'Graphical
      TabIndex        =   1
   ...
   Begin VB.CommandButton cmdConfiguracao_relatorio 
      ...
      Height          =   795
      Left            =   11670
      Picture         =   "frmConsole_Operacao_Caixa.frx":2054
      Style           =   1  'Graphical
      TabIndex        =   0
   ...
   End
End
Attribute VB_Name = "frmConsole_Operacao_Caixa"
