...
Begin VB.Form frmConsole_Relatorio_Operador_Ecf 
   ...
   EndProperty
   Icon            =   "frmConsole_Operador_Ecf.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin VB.CommandButton cmdConfiguracao_impressora 
      ...
      Height          =   795
      Left            =   10710
      Picture         =   "frmConsole_Operador_Ecf.frx":038A
      Style           =   1  'Graphical
      TabIndex        =   1
   ...
   Begin VB.CommandButton cmdConfiguracao_relatorio 
      ...
      Height          =   795
      Left            =   11670
      Picture         =   "frmConsole_Operador_Ecf.frx":2054
      Style           =   1  'Graphical
      TabIndex        =   0
   ...
   End
End
Attribute VB_Name = "frmConsole_Relatorio_Operador_Ecf"
...
Private Sub Form_Load()
    ...
    intTamanho_string = Len(frmOperador_Ecf.strSql)
    inttamanho_From = InStr(1, frmOperador_Ecf.strSql, "FROM")
    strSql_antes_from = Mid(frmOperador_Ecf.strSql, 1, inttamanho_From - 1)
    strSql_pos_from = Mid(frmOperador_Ecf.strSql, inttamanho_From, intTamanho_string)
    ...
    strCaminho = Funcoes_Gerais.Abrir_relatorio_registro("Otica", Me) & "\rptOperador_ecf.rpt"
