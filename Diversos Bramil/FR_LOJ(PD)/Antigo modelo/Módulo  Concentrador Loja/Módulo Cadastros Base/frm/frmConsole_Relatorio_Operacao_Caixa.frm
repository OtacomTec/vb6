...
Begin VB.Form frmConsole_Relatorio_Operacao_Caixa 
   ...
   ClientTop       =   435
   ClientWidth     =   12600
   Icon            =   "frmConsole_Relatorio_Operacao_Caixa.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.CommandButton cmdConfiguracao_relatorio 
      Height          =   795
      Left            =   11670
      Picture         =   "frmConsole_Relatorio_Operacao_Caixa.frx":1CCA
      Style           =   1  'Graphical
      TabIndex        =   3
   ...
   Begin VB.CommandButton cmdConfiguracao_impressora 
      Height          =   795
      Left            =   10710
      Picture         =   "frmConsole_Relatorio_Operacao_Caixa.frx":3994
      Style           =   1  'Graphical
      TabIndex        =   2
   ...
   End
End
Attribute VB_Name = "frmConsole_Relatorio_Operacao_Caixa"
...
Private Sub Form_Load()
    ...
    intTamanho_string = Len(frmOperacao_Caixa.strSql)
    inttamanho_From = InStr(1, frmOperacao_Caixa.strSql, "FROM")
    strSql_antes_from = Mid(frmOperacao_Caixa.strSql, 1, inttamanho_From - 1)
    strSql_pos_from = Mid(frmOperacao_Caixa.strSql, inttamanho_From, intTamanho_string)
    ...
    strCaminho = Funcoes_Gerais.Abrir_relatorio_registro("Otica", Me) & "\rptOperacao_caixa.rpt"
