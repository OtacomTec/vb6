...
Function Gravar()
    ...
    strCampo = "PKCofigo_TBPdv,FKCodigo_TBImpressoras_ecf,DFNumero_ecf_TBPdv"
    strValores = "" & txtCodigo & "," & txtImpressora.Text & "," & txtNumero_ECF.Text & " "
    
    If booAlterar = True Then
       log.Evento = "Alterar"
       strSet = "SET DFNumero_ecf_TBPdv = " & txtNumero_ECF.Text & "," & _
                "    FKCodigo_TBImpressoras_ecf = " & txtImpressora.Text & " "
       Call funcoes_banco.Alterar("TBPdv", strSet, "PKCofigo_TBPdv", txtCodigo.Text, "OTICA", Me, "BDRetaguarda")
...
Private Function Excluir()
    ...
    'Excluindo Registro
    Call funcoes_banco.Excluir("TBPdv", "PKCofigo_TBPdv", Me.txtCodigo.Text, "OTICA", Me, "BDRetaguarda")
...
Private Sub txtCodigo_LostFocus()
    If txtCodigo.Text <> Empty And booAlterar = False Then
       Movimentacoes.Verifica_Numero "PKCofigo_TBPdv", "TBPdv", txtCodigo, "OTICA", Me
    End If
End Sub
...
Private Function Reposicao()
    ...
    Movimentacoes.Monta_HFlex_Grid hfgPdv, "1000,1000,1000,2000", "Código,Nº ECF,Impressora,Nome", 4, "OTICA", Me
...
Private Function Consulta()
    ...
    strSql = "SELECT TBPdv.PKCofigo_TBPdv," & _
             "TBPdv.DFNumero_ecf_TBPdv," & _
             "TBPdv.FKCodigo_TBImpressoras_ecf," & _
             "TBImpressoras_ecf.DFNome_TBImpressoras_ecf " & _
             "FROM TBPdv " & _
             "INNER JOIN TBImpressoras_ecf ON TBImpressoras_ecf.PKCodigo_TBImpressoras_ecf = TBPdv.FKCodigo_TBImpressoras_ecf"
        
    If cbbCampos.Text <> "Todos" Then
       If cbbCampos.Text = "Código do PDV" Then
          strSql = strSql & " WHERE convert(nvarchar,PKCofigo_TBPdv) = " & txtConsulta.Text & " "
    ...
    Movimentacoes.Movimenta_HFlex_Grid strSql, hfgPdv, "1000,1000,1000,2000", "Código,Nº ECF,Impressora,Nome", "BDRetaguarda", "OTICA", Me, "S"
