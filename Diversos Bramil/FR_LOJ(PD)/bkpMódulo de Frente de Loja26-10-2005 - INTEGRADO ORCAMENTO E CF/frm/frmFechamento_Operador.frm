...
Begin VB.Form frmFechamento_Operador 
   ...
   Begin VB.PictureBox Picture6 
      ...
      Height          =   615
      Left            =   5910
      Picture         =   "frmFechamento_Operador.frx":1782
      ScaleHeight     =   615
      ScaleWidth      =   435
      TabIndex        =   13
      Top             =   30
...
Private Sub cmdOk_Click()
    ...
    strValores = "" & frmTela_Venda.txtNumero_check_out & "," & _
                 ...
                 "1," & _
                 "1, '" & dtcFinalizadora.Text & "'," & frmTela_Venda.strEmpresa_Operador & ",0"
    ...
    If frmTela_Venda.booCupom_fiscal = True And frmTela_Venda.intImpressoes_suportadas <> 1 Then
       Call Comandos_impressoras_fiscais.Leitura_x(frmTela_Venda.strImpresora)
    End If
...
Private Sub Form_Load()
    ...
    Me.lblPDV.Caption = "N° PDV: " & frmTela_Venda.strPDV
