VERSION 5.00
Begin VB.Form frmAbertura_Encerrantes 
   BackColor       =   &H00FFFFFF&
   BorderStyle     =   0  'None
   Caption         =   "Form1"
   ClientHeight    =   8985
   ...
   Begin VB.PictureBox Picture6 
      ...
      Height          =   615
      Left            =   11520
      Picture         =   "frmAbertura_Encerrantes.frx":0000
      ScaleHeight     =   615
      ScaleWidth      =   435
      TabIndex        =   27
      Top             =   30
   ...
   End
End
Attribute VB_Name = "frmAbertura_Encerrantes"
...
Private Sub cmdOk_Click()
    ...
    Do While txtBico.Count > intContador_bicos
       ...
       If Me.txtBico.Item(intContador_bicos).Visible = True Then
          If Me.txtBico.Item(intContador_bicos).Text = "" Or Me.txtBico.Item(intContador_bicos).Text = 0 Then
...
'''
    ...
    strSql = "INSERT INTO TBENCERRANTE (FKCodigo_TBPdv,FKCodigo_TBOperadores_ecf,DFData_TBEncerrante,DFHora_TBEncerrante,DFAbertura_fechamento_TBEncerrante) " & _
             "VALUES( " & strNumero_PDV & ", " & frmTela_Venda.strCodigo_Operador & ", '" & Format(frmTela_Venda.dtpData_operacao, "YYYYMMDD") & "', '" & Format(Now, "HH:MM:SS") & "','0')"
...
''    Set CNconexao_local_pdv = Nothing
    ...
    MsgBox "Abertura de encerrantes efetuada com sucesso!", vbInformation, "Only Tech"
    Unload Me
...
Private Function Monta_Tela()
    ...
    If rstBombas.EOF = True And rstBombas.EOF = True Then
    ...
    Do While rstBombas.EOF = False
       ...
       Do While rstBomba_bico.EOF = False
          ...
          If rstBomba_bico!DFUltimo_encerrante_TBBomba_bico = "" Or IsNull(rstBomba_bico!DFUltimo_encerrante_TBBomba_bico) Then
             Me.txtBico.Item(intcontBomba_bico).Text = 0
          Else
             Me.txtBico.Item(intcontBomba_bico).Text = rstBomba_bico!DFUltimo_encerrante_TBBomba_bico
          End If
