...
Private Sub cmdOk_Click()
    ...
    If Me.txtFundo_Caixa.Text = "" Or Me.txtFundo_Caixa.Text = 0 Then
        MsgBox "Favor insira um fundo de caixa válido", vbInformation, "Only Tech"
    ...
    strValores = "" & frmTela_Venda.txtNumero_check_out & "," & _
                 ...
                 "1," & _
                 "0, '" & dtcFinalizadora.Text & "'," & frmTela_Venda.strEmpresa_Operador & ",0"
    ...
    If frmTela_Venda.booCupom_fiscal = True And intImpressoes_suportadas <> 2 Then
       Call Comandos_impressoras_fiscais.Sangria(frmTela_Venda.strImpresora, txtFundo_Caixa.Text)
    End If
...
Private Sub Form_Load()
    ...
    'Fazer uma query e pegar todas as movimentações deste operador neste PDV
    '---------------------
